...
| 6 | Codex | Built-in and registered functions | [06-built-in-and-registered-functions.md](transcripts/06-built-in-and-registered-functions.md) | `Pasted markdown (2).md` | Complete | Codex export structure preserved; unrelated local-file search passage redacted for privacy | None | `9611542c701c4eae809d2057128350ad348d56227feff95efe3b62b057514059` |
...
| 11 | Codex | Final write-up and product design | [11-final-writeup-and-product-design.md](transcripts/11-final-writeup-and-product-design.md) | `Pasted markdown (4).md` | Complete | Codex export structure preserved; local paths and unrelated local-file search passages redacted for privacy | None | `e24c3bc3894130f0991f15e11418142f0d1b7ba67bf11d3c1d6b8cd17517a28c` |
